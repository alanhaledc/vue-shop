              ...
              <li v-for="item in cartList" :key="item.productId">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{'check': item.checked}"
                ...
                <div class="cart-tab-2">
                  <div class="item-price">{{item.salePrice | formatPrice}}</div>
                </div>
                ...
                <div class="cart-tab-4">
                  <div class="item-price-total">{{item.salePrice * item.productNum | formatPrice}}</div>
                </div>
          ...
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                Item total: <span class="total-price">{{totalPrice | formatPrice}}</span>
              </div>
              <div class="btn-wrap">
                <a class="btn btn--red" :class="{'btn--dis': !totalPrice}" @click="checkOut">Checkout</a>
              </div>
            </div>
          </div>
        </div>
    ...
    computed: {
      totalPrice() {
        ...
        this.cartList.forEach((item) => {
          if (item.checked) {
            const price = item.salePrice * item.productNum
            allPrice += price
          }
        })
        return allPrice
